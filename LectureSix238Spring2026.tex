...
\end{equation*}
for all $A$ and $C$ (note here that $w(\text{certainty})$ refers to
the function $w$ applied to the plausibility of the certain
proposition). This can happen only if 
...
0 \leq  w(A|B) \leq 1 ~~~ \text{for all $A$ and $B$}. 
\end{equation}
